...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_fft_wan_precomp_gatewarmup",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_fft_cosmos_precomp_gatewarmup",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b", action_expert_variant="gemma_300m",
            use_knowledge_insulation=False,
    ...
    TrainConfig(
        name="pi05_libero_fft_cosmos_libero_version_precomp_gatewarmup",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b", action_expert_variant="gemma_300m",
            use_knowledge_insulation=False,
            use_fast_auxiliary=False,
            use_vega3d=True,
            vega3d_tower_name="cosmos_libero",
            vega3d_tower_kwargs={
                "checkpoint_dir": "/workspace/openpi-Vega3D/ckpts/Cosmos-Predict2.5-2B-Libero",
                "output_spatial": 16,
                "input_resolution": 256,
                "feat_block_idx": 20,
            },
        ...
        data=LeRobotLiberoVegaDataConfig(
            ...
            tower_features_cache_dir="/workspace/openpi-Vega3D/tower_features/physical-intelligence_libero/cosmos_libero_16x2048_w1s1_blk20_t5cond",
            tower_features_cameras=("base_0_rgb", "left_wrist_0_rgb"),
            tower_window=1,
            tower_stride=1,
        ),
    ...
    TrainConfig(
        name="pi05_libero_fft_cosmos_policy_libero_precomp",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=10, discrete_state_input=False,
            paligemma_variant="gemma_2b", action_expert_variant="gemma_300m",
            use_knowledge_insulation=False,
            use_fast_auxiliary=False,
            use_vega3d=True,
            vega3d_tower_name="cosmos_policy_libero",
            vega3d_tower_kwargs={
                "checkpoint_dir": "/workspace/openpi-Vega3D/ckpts/Cosmos-Policy-LIBERO",
                "output_spatial": 16,
                "input_resolution": 256,
                "feat_block_idx": 20,
            },
        ...
        data=LeRobotLiberoVegaDataConfig(
            ...
            tower_features_cache_dir="/workspace/openpi-Vega3D/tower_features/physical-intelligence_libero/cosmos_policy_libero_16x2048_w1s1_blk20_t5cond",
            tower_features_cameras=("base_0_rgb", "left_wrist_0_rgb"),
            tower_window=1,
            tower_stride=1,
        ),
    ...
    TrainConfig(
        name="pi05_libero_lora_wan_precomp_last_blk",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
        ...
        data=LeRobotLiberoVegaDataConfig(
            ...
            tower_features_cache_dir="/workspace/openpi-Vega3D/tower_features/physical-intelligence_libero/wan_t2v_16x1536_w1s1_blk_last",
            tower_features_cameras=("base_0_rgb", "left_wrist_0_rgb"),
            tower_window=1,
            tower_stride=1,
        ),
    ...
    TrainConfig(
        name="pi05_libero_lora_wan_precomp_semonly_last_blk",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,
    ...
    TrainConfig(
        name="pi05_libero_lora_cosmos_libero_precomp",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=10,
            discrete_state_input=False,

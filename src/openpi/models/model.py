...
class Observation(Generic[ArrayT]):
    ...
    # FAST auxiliary token fields (for Knowledge Insulation training).
    # Discretized action tokens predicted autoregressively in the VLM prefix.
...
def preprocess_observation(
    ...
    *,
    ...
    return Observation(
        ...
        fast_tokens=observation.fast_tokens,

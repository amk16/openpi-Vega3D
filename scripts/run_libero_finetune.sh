...
aws s3 sync s3://behavior-challenge/tower_features/ /workspace/openpi-Vega3D/tower_features/
...
HF_HOME=$HF_HOME XLA_PYTHON_CLIENT_MEM_FRACTION=0.95 uv run scripts/train.py \
    ...
    --exp-name=wan_precomp_semonly_v1 \
    --overwrite
